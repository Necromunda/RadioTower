...
Type: float
Unit: second
Description: Time between event spawns
"eventSpawnInterval": 1800.0,

Type: float
Unit: second
Description: Time which event remains capturable after spawn, must be higher than "eventCapturetime"
"eventLifetime": 45.0,

Type: float
Unit: second
Description: Duration players need to be inside the capture area for event to become captured, must be lower than "eventLifetime"
"eventCapturetime": 15.0,

Type: float
Unit: second
Description: Duration it takes for the server to get hacked
"eventHacktime": 1.0,
...
Type: string
Description: Must match with "locationTitle"
